...
export type NotificationType = 'success' | 'error' | 'warning' | 'info' | 'reputation_decay';  
...
/**  
 * Notify users of reputation decay  
 * Uses the existing notification infrastructure  
 */  
export function notifyReputationDecay(  
  circleId: number,  
  oldScore: number,  
  newScore: number,  
  decayAmount: number,  
  ...
  return notificationService.error(  
    ...
    `Your reputation decreased by ${decayAmount} points in circle ${circleId} due to inactivity.`,  
    {  
